...
select
  ...
  case
    when coalesce(sum(t.pnl), 0) + 5 >= 500000 then 'P10'
    when coalesce(sum(t.pnl), 0) + 5 >= 150000 then 'P09'
    when coalesce(sum(t.pnl), 0) + 5 >= 50000  then 'P08'
    ...
    when coalesce(sum(t.pnl), 0) + 5 >= 5      then 'P01'
    else 'P01'
